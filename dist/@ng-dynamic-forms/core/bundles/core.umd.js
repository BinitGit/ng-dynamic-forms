...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DynamicFormOption = /** @class */ (function () {
        ...
        __decorate$a([
            serializable(),
            __metadata$a("design:type", typeof (_a = typeof T !== "undefined" && T) === "function" && _a || Object)
    ...
    var DynamicSelectModel = /** @class */ (function (_super) {
        ...
        function DynamicSelectModel(config, layout) {
            ...
            _this.compareWithFn = isFunction(config.compareWithFn) ? config.compareWithFn : i0.ɵlooseIdentical;
