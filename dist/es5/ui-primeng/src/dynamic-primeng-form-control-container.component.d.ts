...
export declare class DynamicPrimeNGFormControlContainerComponent extends DynamicFormControlContainerComponent {
...
export declare function primeNGUIFormControlMapFn(model: DynamicFormControlModel): Type<DynamicFormControl> | null;
